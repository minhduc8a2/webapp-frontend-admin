...
/// configure here
const fieldList = [
  { fullName: "Mã số nhân viên", field: "MSNV", type: "text", min: 1 },
  { fullName: "Họ tên", field: "HoTenNV", type: "text", min: 1 },
  { fullName: "Mật khẩu", field: "Password", type: "password", min: 8 },
  { fullName: "Chức vụ", field: "ChucVu", type: "text", min: 1 },
  { fullName: "Địa chỉ", field: "DiaChi", type: "text", min: 1 },
  { fullName: "Số điện thoại", field: "SoDienThoai", type: "text", min: 10 },
]
